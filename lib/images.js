...
export const images = {
  hero: {
    // Technician helping an older adult with a device at home
    src: unsplash("photo-1573497491765-dccce02b29df", 1400),
    alt: "Friendly technician helping an older adult with a tablet at home",
  },
  services: {
